...
Merged to `main`. Full entry in §2.) Prior (2026-09-06), **Hero background — dot
matrix + per-song colour schemes**: the neon skyline bars are replaced by a colour DOT MATRIX rising
